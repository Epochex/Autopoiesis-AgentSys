import type { ControlLoopSnapshot } from '../types'

// Historical fallback fixture for offline rendering and compare mode.
// Top-level repo/control-loop metadata is kept aligned with the current mounted artifact set,
// while detailed per-suggestion traces below remain stable example records.
export const controlLoopSnapshot: ControlLoopSnapshot = {
  repo: {
    branch: 'main',
    validation: '33 tests collected · docs aligned to current mounted artifact set',
  },
  controlLoop: {
    latestAlertTs: '2026-03-27T23:00:17+00:00',
    latestSuggestionTs: '2026-03-31T15:36:55.895982+00:00',
    contextNote:
      'Fallback snapshot aligned to current mounted /data/netops-runtime facts. The mounted workspace exposes alert/suggestion artifacts but not a live, fully time-aligned edge artifact path.',
  },
  ...
  overviewMetrics: [
    ...
    },
    {
      ...
      value: 'artifact-only',
      hint: 'Mounted artifacts prove alert/suggestion products exist, but they do not expose a fresh synchronized raw artifact audit window.',
      state: 'watch',
    },
    {
      id: 'lag',
    ...
    },
    {
      ...
      hint: 'Execution feedback is still a reserved control point, not a wired control-loop stage yet.',
      state: 'watch',
    },
  ],
  cadence: {
  ...
  stageNodes: [
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: 'backlog', value: 'artifact root not mounted' },
      ],
    },
    {
      id: 'forwarder',
  ...
  strategyControls: [
    {
      ...
      detail: 'Deterministic alert gate for deny_burst_v1 under normal control-loop conditions.',
    },
    {
      id: 'rule-cooldown',
  ...
  feed: [
    ...
    },
    {
      ...
      detail:
        'Latest control-loop check kept history_backlog_suspected=false with raw payload age in single-digit seconds.',
    },
  ],
  topologyNotes: [
    {
