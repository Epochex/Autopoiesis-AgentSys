...
class PlannerAgent:
    ...
    def propose(self, case, diagnosis, executed: set[str]) -> list[str]:
...
class ExecutorAgent:
    ...
    def run(self, case, skill_names: list[str], registry: SkillRegistry) -> tuple[list[dict], float]:
        evidence: list[dict] = []
        total_cost = 0.0
...
class CriticAgent:
    ...
    def review(self, case, evidence, context_compiler, diagnosis_builder, verifier, memories):
